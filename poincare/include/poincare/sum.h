...
public:
  ...
  static Sum Builder(Expression child0, Symbol child1, Expression child2, Expression child3) { return TreeHandle::FixedArityBuilder<Sum, SumNode>(ArrayBuilder4<TreeHandle>(child0, child1, child2, child3).array(), 4); }
