...
private:
  ...
  static constexpr int k_maxNumberOfDisplayableAbscissaCells = Shared::NewFunction::k_numberOfPlotTypes * k_maxNumberOfDisplayableRows;
  ...
  Shared::NewFunction::PlotType plotTypeAtColumn(int * i) const;
  ...
  int abscissaTitleCellsCount() const override { return Shared::NewFunction::k_numberOfPlotTypes; }
  ...
  mutable int m_numberOfValuesColumnsForType[Shared::NewFunction::k_numberOfPlotTypes];
  ...
  AbscissaTitleCell m_abscissaTitleCells[Shared::NewFunction::k_numberOfPlotTypes];
