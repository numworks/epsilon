#ifndef PROBABILITY_GUI_MESSAGE_TABLE_CELL_WITH_SEPARATOR_H
#define PROBABILITY_GUI_MESSAGE_TABLE_CELL_WITH_SEPARATOR_H
...
#endif /* PROBABILITY_GUI_MESSAGE_TABLE_CELL_WITH_SEPARATOR_H */
