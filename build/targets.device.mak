...
$(BUILD_DIR)/userland.A.$(EXE): $(call flavored_object_for,$(userland_src),$(USBXIP) leaveauthentify consoledisplay onboarding.beta)
$(BUILD_DIR)/userland.B.$(EXE): $(call flavored_object_for,$(userland_src),$(USBXIP) leaveauthentify consoledisplay onboarding.beta)
