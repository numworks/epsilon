...
private:
  ...
  // strlen(k_importCommand1) + strlen(k_importCommand2) + TextField::maxBufferSize()
  constexpr static size_t k_maxImportCommandSize = 5 + 9 + Escher::TextField::MaxBufferSize();
