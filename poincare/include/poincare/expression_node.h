  ...
  public:
    ...
    public:
      ComputationContext(
          ...
          Preferences::AngleUnit angleUnit) : m_context(context),
    ...
    {
    public:
      ReductionContext(Context *context, Preferences::ComplexFormat complexFormat, Preferences::AngleUnit angleUnit, Preferences::UnitFormat unitFormat, ReductionTarget target, SymbolicComputation symbolicComputation = SymbolicComputation::ReplaceAllDefinedSymbolsWithDefinition, UnitConversion unitConversion = UnitConversion::Default) : ComputationContext(context, complexFormat, angleUnit),
    ...
    public:
      ApproximationContext(
          ...
          bool withinReduce = false) : ComputationContext(context, complexFormat, angleUnit),
