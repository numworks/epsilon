...
QUIZ_CASE(liba_ieee754) {
  ...
  quiz_assert(ieee754man64(123.456) ==
              0b1110110111010010111100011010100111111011111001110111);
  quiz_assert(ieee754exp64(123.456) == 0b10000000101);
  quiz_assert(ieee754man64(555.555) ==
              0b0001010111000111000010100011110101110000101000111101);
  quiz_assert(ieee754exp64(555.555) == 0b10000001000);
  quiz_assert(ieee754man64(0.007) ==
              0b1100101011000000100000110001001001101110100101111001);
