...
const TrigonometryCheatTable * TrigonometryCheatTable::Table() {
  static Row sTableRows[] = {
    ...
    Row(Row::Pair("45",45.0f),
        ...
        Row::Pair("1",1.0f)),
    Row(Row::Pair("54",54.0f),
        Row::Pair("\x8A*3*10^(-1)",0.9424777960769379f),
