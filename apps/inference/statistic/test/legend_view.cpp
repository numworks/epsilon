...
LegendView::LegendView()
    : m_pValueLabel(KDFont::Size::Small, I18n::Message::PValue, 0.0, 0.0,
                    Palette::GrayVeryDark, k_backgroundColor),
      m_alphaLabel(KDFont::Size::Small, I18n::Message::GreekAlpha, 0.0, 0.0,
                   Palette::GrayVeryDark, k_backgroundColor) {}
