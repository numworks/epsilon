...
public:
  ...
  bool ParametersAreOK(const float * parameters) override { return ParametersAreOK(parameters[0], parameters[1]); }
  bool ParametersAreOK(const double * parameters) override { return ParametersAreOK(parameters[0], parameters[1]); }

  static bool ExpressionParametersAreOK(bool * result, const Expression &n, const Expression &p, Context * context);
  bool ExpressionParametersAreOK(bool * result, const Expression * parameters, Context * context) override { return ExpressionParametersAreOK(result, parameters[0], parameters[1], context); }
