...
QUIZ_CASE(liba_llsr) {
  quiz_assert(__aeabi_llsr((uint64_t)0x8000000000000000, 1) ==
              (uint64_t)0x4000000000000000);
  quiz_assert(__aeabi_llsr((uint64_t)0x8000000000000000, 2) ==
              (uint64_t)0x2000000000000000);
  quiz_assert(__aeabi_llsr((uint64_t)0x8000000000000000, 10) ==
              (uint64_t)0x20000000000000);
  quiz_assert(__aeabi_llsr((uint64_t)0x8000000000000000, 20) ==
              (uint64_t)0x80000000000);
  quiz_assert(__aeabi_llsr((uint64_t)0x8000000000000000, 30) ==
              (uint64_t)0x200000000);
  quiz_assert(__aeabi_llsr((uint64_t)0x8000000000000000, 31) ==
              (uint64_t)0x100000000);
  quiz_assert(__aeabi_llsr((uint64_t)0x8000000000000000, 32) ==
              (uint64_t)0x80000000);
  quiz_assert(__aeabi_llsr((uint64_t)0x8000000000000000, 33) ==
              (uint64_t)0x40000000);
  quiz_assert(__aeabi_llsr((uint64_t)0x8000000000000000, 40) ==
              (uint64_t)0x800000);
  quiz_assert(__aeabi_llsr((uint64_t)0x8000000000000000, 50) ==
              (uint64_t)0x2000);
