...
public:
  FunctionAxis() : Shared::PlotPolicy::LabeledAxis<N>::LabeledAxis(), m_specialLabelRect(KDRectZero) {}
  void reloadAxis(Shared::AbstractPlotView * plotView, Shared::AbstractPlotView::Axis axis) override;
  void drawAxis(const Shared::AbstractPlotView * plotView, KDContext * ctx, KDRect rect, Shared::AbstractPlotView::Axis axis) const;
private:
...
typedef FunctionAxis<Shared::PlotPolicy::AbstractLabeledAxis::k_maxNumberOfXLabels> FunctionHorizontalLabeledAxis;
typedef FunctionAxis<Shared::PlotPolicy::AbstractLabeledAxis::k_maxNumberOfYLabels> FunctionVerticalLabeledAxis;

typedef Shared::PlotPolicy::Axes<Shared::PlotPolicy::WithGrid, FunctionHorizontalLabeledAxis, FunctionVerticalLabeledAxis> FunctionTwoLabeledAxes;
