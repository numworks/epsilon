...
constexpr ToolboxMessageTree TurtleModuleChildren[] = {
    ...
    ToolboxMessageTree::Leaf(I18n::Message::PythonTurtleCommandDistance,
                             I18n::Message::PythonTurtleDistance, false),
