...
QUIZ_CASE(poincare_product_evaluate) {
  ...
  assert_parsed_expression_evaluate_to("2*[[1,2][3,4][5,6]]", c, 3, 2);
  ...
  assert_parsed_expression_evaluate_to("[[1,2][3,4][5,6]]*[[1,2,3,4][5,6,7,8]]", e, 3, 4);
  ...
  assert_parsed_expression_evaluate_to("[[1,2+I][3,4][5,6]]*[[1,2+I,3,4][5,6+I,7,8]]", f, 3, 4);
#endif
}
