...
QUIZ_CASE(probability_binomial_distribution) {
  ...
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(4), std::pow(1 - 0.6, 32 - 4) * std::pow(0.6, 4) * 35960 /* 32 choose 4 */, 1e-4);
  ...
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(4), std::pow(1 - 0.1, 17 - 4) * std::pow(0.1, 4) * 2380 /* 17 choose 4 */, 1e-5);
  ...
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(4), std::pow(1 - 0.2, 21 - 4) * std::pow(0.2, 4) * 5985 /* 21 choose 4 */, 1e-5);
...
QUIZ_CASE(probability_uniform_distribution) {
  // U(-1, 1)
  Probability::UniformDistribution distribution;
  distribution.setParameterAtIndex(-1, 0);
  distribution.setParameterAtIndex(1, 1);
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(4), 0);
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(.2), 1. / 2.f);
  ...
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(4), 1.f / (17.f - .1f));
...
QUIZ_CASE(probability_exponential_distribution) {
  ...
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(2), .2f * std::exp(-.2f * 2.f));
...
QUIZ_CASE(probability_chi_squared_distribution) {
  ...
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(0.1), 1.2f, 1e-4);
  ...
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(0.1), 0.98f, 1e-5);
  ...
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(0.1), 0.001890880662848345f, 1e-6);
  ...
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(0.1), 0.0005945183903129464f, 1e-6);
...
QUIZ_CASE(probability_student_distribution) {
  ...
  distribution.setParameterAtIndex(1.0, 0);
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(0.1), 0.31515830315226806f);
  ...
  distribution.setParameterAtIndex(1.3, 0);
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(0.1), 0.33047714482602075f);
  ...
  distribution.setParameterAtIndex(5.4, 0);
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(0.1), 0.3787417926621869f, 1e-6);
  ...
  distribution.setParameterAtIndex(6.0, 0);
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(0.1), 0.38050851123793844f);
  assert_finite_integral_between_abscissas_is(&distribution, 4.0, 4.0, 0.0);
  assert_finite_integral_between_abscissas_is(&distribution, 5.0, 4.0, 0.0);
...
QUIZ_CASE(probability_geometric_distribution) {
  ...
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(3), 1.f / 8.f);
  ...
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(4), 0.1024);
  ...
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(4), 0.0864, 1e-6);
...
QUIZ_CASE(probability_normal_distribution) {
  // N(0, 1)
  Probability::NormalDistribution distribution;
  distribution.setParameterAtIndex(0, 0);
  distribution.setParameterAtIndex(1, 1);
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(1), 0.24197072451914337);
  ...
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(103), 0.005879554726599732);
  ...
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(-1), 1.0648266850745078, 1e-6);
...
QUIZ_CASE(probability_fisher_distribution) {
  ...
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(1), 0.15915494309189535);
  ...
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(1), 0.27885480092693415);
  ...
  distribution.setParameterAtIndex(2.0, 1);
  assertRoughlyEqual<float>(distribution.evaluateAtAbscissa(1), 0.2962962962962962);
