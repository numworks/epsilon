...
protected:
  bool privateMoveCursorHorizontally(Shared::CurveViewCursor * cursor, OMG::NewHorizontalDirection direction, Shared::InteractiveCurveViewRange * range, int numberOfStepsInGradUnit, Ion::Storage::Record record, float pixelWidth, int scrollSpeed = 1, int * subCurveIndex = nullptr);
...
private:
  ...
  virtual void jumpToLeftRightCurve(double t, OMG::NewHorizontalDirection direction, int functionsCount, Ion::Storage::Record record) {}
};
