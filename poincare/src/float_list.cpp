...
Expression FloatList<T>::floatExpressionAtIndex(int index) const {
  ...
  assert((childAtIndex(index).type() == ExpressionNode::Type::Float && sizeof(T) == sizeof(float)) || (childAtIndex(index).type() == ExpressionNode::Type::Double && sizeof(T) == sizeof(double)));
