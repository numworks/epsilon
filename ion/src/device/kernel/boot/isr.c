...
ISR InitialisationVector[INITIALISATION_VECTOR_SIZE]
  ...
  keyboard_handler, // EXTI0 service routine
  keyboard_handler, // EXTI1 service routine
  keyboard_handler, // EXTI2 service routine
  keyboard_handler, // EXTI3 service routine
  keyboard_handler, // EXTI4 service routine
  ...
  keyboard_handler, // EXTI Line[9:5] interrupts
