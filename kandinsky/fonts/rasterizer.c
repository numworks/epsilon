...
void writeFontSourceFile(const char * fontSourceFilename, const char * fontName, int glyphWidth,
  ...
  fprintf(fontFile, "constexpr static KDCoordinate glyphWidth = %d;\n", glyphWidth);
  fprintf(fontFile, "static_assert(glyphWidth == KDFont::k_glyphWidth%s, \"Header's replicated value is erroneous.\");\n\n", fontName);
  fprintf(fontFile, "constexpr static KDCoordinate glyphHeight = %d;\n", glyphHeight);
  fprintf(fontFile, "static_assert(glyphHeight == KDFont::k_glyphHeight%s, \"Header's replicated value is erroneous.\");\n\n", fontName);
