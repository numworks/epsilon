...
QUIZ_CASE(poincare_polynomial_roots_cubic) {
  ...
  assert_roots_of_polynomial_are("2x^3-ℯ^(2𝐢π/7)", {"7.937005ᴇ-1×ℯ^2.393594×𝐢", "7.937005ᴇ-1×ℯ^-1.795196×𝐢", "7.937005ᴇ-1×ℯ^2.991993ᴇ-1×𝐢"}, "1.08ᴇ2×ℯ^-1.346397×𝐢", Polar);
  assert_roots_of_polynomial_are("x^3-ℯ^(2𝐢π/7)-1", {"1.216877×ℯ^2.243995×𝐢", "1.216877×ℯ^-1.944795×𝐢", "1.216877×ℯ^1.495997ᴇ-1×𝐢"}, "8.766845ᴇ1×ℯ^-2.243995×𝐢", Polar);
