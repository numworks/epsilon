...
static const struct WebUSBDevice::BinaryDeviceObjectStore bosDescriptor = {
...
static const struct WebUSBDevice::PlatformDescriptor webUSBPlatformDescriptor = {
...
int WebUSBDevice::buildDataToSend(SetupData setupData, uint8_t ** bufferToSend, uint16_t * bufferToSendLength, uint8_t * bufferForWriting) {
...
uint16_t WebUSBDevice::buildBOSDescriptor(uint8_t * buffer, uint16_t bufferLength) {
