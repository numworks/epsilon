...
private:
  ...
  constexpr static int k_maxNumberOfCharsInBuffer = (Ion::Display::Width - Escher::Metric::PopUpLeftMargin - 2 * Escher::Metric::CellSeparatorThickness - Escher::Metric::CellLeftMargin - Escher::Metric::CellRightMargin - Escher::Metric::PopUpRightMargin) / 7; // With 7 = KDFont::GlyphSize(KDFont::Size::Small).width()
