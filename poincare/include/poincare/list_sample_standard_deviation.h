...
public:
  ...
  constexpr static FunctionHelper s_functionHelperOneChild = FunctionHelper(k_functionName, 1, &Initializer<ListSampleStandardDeviationNode<1>>, sizeof(ListSampleStandardDeviationNode<1>));
  constexpr static FunctionHelper s_functionHelperTwoChildren = FunctionHelper(k_functionName, 2, &Initializer<ListSampleStandardDeviationNode<2>>, sizeof(ListSampleStandardDeviationNode<2>));
