#ifndef APPS_PROBABILITY_MODELS_STATISTIC_CACHED_STATISTIC_H
#define APPS_PROBABILITY_MODELS_STATISTIC_CACHED_STATISTIC_H
...
#endif /* APPS_PROBABILITY_MODELS_STATISTIC_CACHED_STATISTIC_H */
