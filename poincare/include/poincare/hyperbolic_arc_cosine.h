...
public:
  static constexpr char functionName[] = "acosh";
...
class HyperbolicArcCosine final : public HandleOneChildWithParent<HyperbolicArcCosine, HyperbolicArcCosineNode, HyperbolicTrigonometricFunction> {
public:
