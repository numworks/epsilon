#ifndef ION_DEVICE_USB_WINUSB_DEVICE_H
#define ION_DEVICE_USB_WINUSB_DEVICE_H
...
struct OSExtendedPropertiesGUIDFunction {
  ...
  bool buildWindowsOSStringDescriptor(SetupPacket * setupPacket, uint8_t ** bufferToSend, uint16_t * bufferToSendLength, uint8_t * bufferForWriting) override;
private:
