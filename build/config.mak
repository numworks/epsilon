...
# Unless specified, ASSERTIONS default value depends on the firmware compoment
ifndef ASSERTIONS
ASSERTIONS = $(DEBUG)
BOOTLOADER_ASSERTIONS ?= $(DEVELOPMENT)
KERNEL_ASSERTIONS ?= $(DEVELOPMENT)
else
BOOTLOADER_ASSERTIONS ?= $(ASSERTIONS)
KERNEL_ASSERTIONS ?= $(ASSERTIONS)
endif
USERLAND_ASSERTIONS ?= $(ASSERTIONS)
