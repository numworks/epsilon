...
number:
  ...
  | DOT DIGITS { Poincare::Integer exp = Poincare::Integer::exponent($2.length, nullptr, 0, false); Poincare::Integer numerator = Poincare::Integer::numerator(nullptr, 0, $2.address, $2.length, false, &exp); Poincare::Integer denominator = Poincare::Integer::denominator(&exp); $$ = new Poincare::Rational(numerator, denominator); }
  | DIGITS DOT DIGITS { Poincare::Integer exp = Poincare::Integer::exponent($3.length, nullptr, 0, false); Poincare::Integer numerator = Poincare::Integer::numerator($1.address, $1.length, $3.address, $3.length, false, &exp); Poincare::Integer denominator = Poincare::Integer::denominator(&exp); $$ = new Poincare::Rational(numerator, denominator); }
  | DOT DIGITS EE DIGITS { Poincare::Integer exp = Poincare::Integer::exponent($2.length, $4.address, $4.length, false); Poincare::Integer numerator = Poincare::Integer::numerator(nullptr, 0, $2.address, $2.length, false, &exp); Poincare::Integer denominator = Poincare::Integer::denominator(&exp); $$ = new Poincare::Rational(numerator, denominator); }
  | DIGITS DOT DIGITS EE DIGITS { Poincare::Integer exp = Poincare::Integer::exponent($3.length, $5.address, $5.length, false) ; Poincare::Integer numerator = Poincare::Integer::numerator($1.address, $1.length, $3.address, $3.length, false, &exp); Poincare::Integer denominator = Poincare::Integer::denominator(&exp) ;
$$ = new Poincare::Rational(numerator, denominator); }
  | DIGITS EE DIGITS { Poincare::Integer exp = Poincare::Integer::exponent(0, $3.address, $3.length, false); Poincare::Integer numerator = Poincare::Integer::numerator($1.address, $1.length, nullptr, 0, false, &exp); Poincare::Integer denominator = Poincare::Integer::denominator(&exp); $$ = new Poincare::Rational(numerator, denominator); }
  | DOT DIGITS EE MINUS DIGITS { Poincare::Integer exp = Poincare::Integer::exponent($2.length, $5.address, $5.length, true); Poincare::Integer numerator = Poincare::Integer::numerator(nullptr, 0, $2.address, $2.length, false, &exp); Poincare::Integer denominator = Poincare::Integer::denominator(&exp); $$ = new Poincare::Rational(numerator, denominator); }
  ...
  | DIGITS EE MINUS DIGITS { Poincare::Integer exp = Poincare::Integer::exponent(0, $4.address, $4.length, true); Poincare::Integer numerator = Poincare::Integer::numerator($1.address, $1.length, nullptr, 0, false, &exp); Poincare::Integer denominator = Poincare::Integer::denominator(&exp); $$ = new Poincare::Rational(numerator, denominator); }
