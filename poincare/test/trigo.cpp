...
QUIZ_CASE(poincare_trigo_simplify) {
  ...
  assert_parsed_expression_simplify_to("cos(15)", "(R(2)+R(6))/4", Preferences::AngleUnit::Degree);
  assert_parsed_expression_simplify_to("cos(-15)", "(R(2)+R(6))/4", Preferences::AngleUnit::Degree);
  assert_parsed_expression_simplify_to("cos(-765/2)", "R(2+R(2))/2", Preferences::AngleUnit::Degree);
  ...
  assert_parsed_expression_simplify_to("sin(-765/2)", "-R(2-R(2))/2", Preferences::AngleUnit::Degree);
