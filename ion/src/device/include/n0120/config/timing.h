...
constexpr static int LoopsPerMillisecondLowFrequency = 10485;
constexpr static int LoopsPerMillisecondHighFrequency = 8*10485;
constexpr static int LoopsPerMicrosecond = 43;
