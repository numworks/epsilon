...
void check_sequences_defined_by(double result[2][10], Sequence::Type typeU, const char * definitionU, const char * conditionU1 = nullptr, const char * conditionU2 = nullptr, Sequence::Type typeV = Sequence::Type::Explicite, const char * definitionV = nullptr, const char * conditionV1 = nullptr, const char * conditionV2 = nullptr) {
...
QUIZ_CASE(sequence_evaluation) {
  ...
  check_sequences_defined_by(result0, Sequence::Type::Explicite, "n");
  ...
  check_sequences_defined_by(result3, Sequence::Type::Explicite, "n", nullptr, nullptr, Sequence::Type::Explicite, "u(n)+n");
  ...
  check_sequences_defined_by(result4, Sequence::Type::SingleRecurrence, "n+u(n)", "0", nullptr, Sequence::Type::Explicite, "u(n)+n");
  ...
  check_sequences_defined_by(result5, Sequence::Type::DoubleRecurrence, "n+u(n)+u(n+1)", "0", "0", Sequence::Type::Explicite, "u(n)+n");
  ...
  check_sequences_defined_by(result6, Sequence::Type::Explicite, "n", nullptr, nullptr, Sequence::Type::SingleRecurrence, "u(n)+u(n+1)+n", "0");
  ...
  check_sequences_defined_by(result9, Sequence::Type::Explicite, "n", nullptr, nullptr, Sequence::Type::DoubleRecurrence, "u(n)+u(n+1)+n", "0", "0");
  ...
  check_sequences_defined_by(result12, Sequence::Type::Explicite, "v(n)", nullptr, nullptr, Sequence::Type::Explicite, "u(n)");
  ...
  check_sequences_defined_by(result13, Sequence::Type::SingleRecurrence, "v(n)+n", "0", nullptr, Sequence::Type::Explicite, "u(n)+n");
  ...
  check_sequences_defined_by(result14, Sequence::Type::DoubleRecurrence, "v(n+1)+v(n)+u(n+1)+u(n)+n", "0", "0", Sequence::Type::Explicite, "u(n)+n");

  // u(n) = v(n)+n; v(n+1) = u(n)+n, v(0)=0
  double result15[2][10] = {{0.0, 1.0, 4.0, 9.0, 16.0, 25.0, 36.0, 49.0, 64.0, 81},
    {0.0, 0.0, 2.0, 6.0, 12.0, 20.0, 30.0, 42.0, 56.0, 72.0}};
  check_sequences_defined_by(result15, Sequence::Type::Explicite, "v(n)+n", nullptr, nullptr, Sequence::Type::SingleRecurrence, "u(n)+n", "0");
