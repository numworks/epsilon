...
parser = argparse.ArgumentParser(
    description="Parse ELF file and output metrics in JSON"
)
...
parser.add_argument(
    ...
    type=int,
    metavar="N",
    help="output symbols information (only the N largest)",
)
parser.add_argument(
    "-S", "--sections", action="store_true", help="output sections information"
)
