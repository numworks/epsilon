...
$(call flavored_object_for,$(ion_device_dfu_binary_src),n0100): SFLAGS += -Iion/src/device/shared -Iion/src/device #TODO EMILIE: remove */shared and specify shared in inclusions
