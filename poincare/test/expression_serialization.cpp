...
QUIZ_CASE(poincare_serialization_rational) {
  ...
  assert_expression_serialize_to(
      ...
      "789");
  assert_expression_serialize_to(Rational::Builder(-2, 3), "-2/3");
  assert_expression_serialize_to(Rational::Builder("2345678909876"),
                                 "2345678909876");
  assert_expression_serialize_to(Rational::Builder("-2345678909876", "5"),
                                 "-2345678909876/5");
  assert_expression_serialize_to(Rational::Builder(MaxIntegerString()),
                                 MaxIntegerString());
  Integer one(1);
...
QUIZ_CASE(poincare_serialization_decimal) {
  ...
  assert_expression_serialize_to(Decimal::Builder(0.25), "250ᴇ-3",
                                 EngineeringMode);
  assert_expression_serialize_to(Decimal::Builder(-1.23456789E30),
                                 "-1.23456789ᴇ30", ScientificMode, 14);
  assert_expression_serialize_to(Decimal::Builder(1.23456789E30),
                                 "1.23456789ᴇ30", ScientificMode, 14);
  assert_expression_serialize_to(Decimal::Builder(-1.23456789E-30),
                                 "-1.23456789ᴇ-30", ScientificMode, 14);
  assert_expression_serialize_to(Decimal::Builder(-1.2345E-3), "-0.0012345",
                                 DecimalMode);
  assert_expression_serialize_to(Decimal::Builder(1.2345E-3), "0.0012345",
                                 DecimalMode);
  assert_expression_serialize_to(Decimal::Builder(1.2345E3), "1234.5",
                                 DecimalMode);
  assert_expression_serialize_to(Decimal::Builder(-1.2345E3), "-1234.5",
                                 DecimalMode);
  assert_expression_serialize_to(Decimal::Builder(1.2345E6), "1234500",
                                 DecimalMode);
  assert_expression_serialize_to(Decimal::Builder(-1.2345E6), "-1234500",
                                 DecimalMode);
  assert_expression_serialize_to(Decimal::Builder(-1.2345E-1), "-0.12345",
                                 DecimalMode);
  assert_expression_serialize_to(Decimal::Builder(1.2345E-1), "0.12345",
                                 DecimalMode);
  assert_expression_serialize_to(Decimal::Builder(1.0), "1");
  assert_expression_serialize_to(Decimal::Builder(0.9999999999999996), "1");
  assert_expression_serialize_to(Decimal::Builder(0.99999999999995),
                                 "9.9999999999995ᴇ-1", ScientificMode, 14);
  assert_expression_serialize_to(Decimal::Builder(0.00000099999999999995),
                                 "9.9999999999995ᴇ-7", ScientificMode, 14);
  assert_expression_serialize_to(Decimal::Builder(0.000000999999999999995),
                                 "1ᴇ-6", DecimalMode);
  assert_expression_serialize_to(
      Decimal::Builder(0.000000999999999901200121020102010201201201021099995),
      "9.999999999012ᴇ-7", DecimalMode, 14);
  assert_expression_serialize_to(Decimal::Builder(9999999999999.53),
                                 "9999999999999.5", DecimalMode, 14);
  assert_expression_serialize_to(Decimal::Builder(99999999999999.54), "1ᴇ14",
                                 DecimalMode, 14);
  assert_expression_serialize_to(Decimal::Builder(999999999999999.54), "1ᴇ15",
                                 DecimalMode, 14);
  assert_expression_serialize_to(Decimal::Builder(9999999999999999.54), "1ᴇ16",
                                 DecimalMode, 14);
  assert_expression_serialize_to(Decimal::Builder(-9.702365051313E-297),
                                 "-9.702365051313ᴇ-297", DecimalMode, 14);

  // Engineering notation
  assert_expression_serialize_to(Decimal::Builder(0.0), "0", EngineeringMode,
                                 7);
  assert_expression_serialize_to(Decimal::Builder(10.0), "10", EngineeringMode,
                                 7);
  assert_expression_serialize_to(Decimal::Builder(100.0), "100",
                                 EngineeringMode, 7);
  assert_expression_serialize_to(Decimal::Builder(1000.0), "1ᴇ3",
                                 EngineeringMode, 7);
  assert_expression_serialize_to(Decimal::Builder(1234.0), "1.234ᴇ3",
                                 EngineeringMode, 7);
  assert_expression_serialize_to(Decimal::Builder(-0.1), "-100ᴇ-3",
                                 EngineeringMode, 7);
  assert_expression_serialize_to(Decimal::Builder(-0.01), "-10ᴇ-3",
                                 EngineeringMode, 7);
  assert_expression_serialize_to(Decimal::Builder(-0.001), "-1ᴇ-3",
                                 EngineeringMode, 7);
}

QUIZ_CASE(poincare_serialization_float) {
  assert_expression_serialize_to(Float<double>::Builder(-1.23456789E30),
                                 "-1.23456789ᴇ30", DecimalMode, 14);
  assert_expression_serialize_to(Float<double>::Builder(1.23456789E30),
                                 "1.23456789ᴇ30", DecimalMode, 14);
  assert_expression_serialize_to(Float<double>::Builder(-1.23456789E-30),
                                 "-1.23456789ᴇ-30", DecimalMode, 14);
  assert_expression_serialize_to(Float<double>::Builder(-1.2345E-3),
                                 "-0.0012345", DecimalMode);
  assert_expression_serialize_to(Float<double>::Builder(1.2345E-3), "0.0012345",
                                 DecimalMode);
  assert_expression_serialize_to(Float<double>::Builder(1.2345E3), "1234.5",
                                 DecimalMode);
  assert_expression_serialize_to(Float<double>::Builder(-1.2345E3), "-1234.5",
                                 DecimalMode);
  assert_expression_serialize_to(Float<double>::Builder(0.99999999999995),
                                 "9.9999999999995ᴇ-1", ScientificMode, 14);
  assert_expression_serialize_to(
  ...
  assert_expression_serialize_to(Float<float>::Builder(1.2345E-1), "0.12345",
                                 DecimalMode);
  assert_expression_serialize_to(Float<float>::Builder(1), "1", DecimalMode);
  assert_expression_serialize_to(Float<float>::Builder(0.9999999999999995), "1",
                                 DecimalMode);
  assert_expression_serialize_to(Float<float>::Builder(1.2345E6), "1234500",
                                 DecimalMode);
  assert_expression_serialize_to(Float<float>::Builder(-1.2345E6), "-1234500",
                                 DecimalMode);
  assert_expression_serialize_to(
  ...
  assert_expression_serialize_to(Float<double>::Builder(INFINITY),
                                 Infinity::Name(), DecimalMode);
  assert_expression_serialize_to(Float<float>::Builder(0.0f), "0", DecimalMode);
  assert_expression_serialize_to(Float<float>::Builder(NAN), Undefined::Name(),
                                 DecimalMode);
}
...
QUIZ_CASE(poincare_serialization_factorial) {
  assert_expression_serialize_to(Factorial::Builder(Rational::Builder(2, 3)),
                                 "\u00122/3\u0013!");
  assert_expression_serialize_to(
      Factorial::Builder(
