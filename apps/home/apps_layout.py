...
parser = argparse.ArgumentParser(
    description="Build tools for the placement of applications on the home menu."
)
...
def print_implementation(implementation, data):
    ...
    for i in range(len(styles)):
        ...
        f.write(
            "static_assert("
            + styles[i]
            + 'AppsPermutation[0] == 0, "The Home apps must always be at index 0");\n\n'
        )
    ...
    for i in range(len(styles)):
        f.write(
            "  if (currentLayout == CountryPreferences::HomeAppsLayout::"
            + styles[i]
            + ") {\n"
        )
