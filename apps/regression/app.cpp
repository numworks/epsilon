  ...
  m_regressionTypes{Model::Type::None, Model::Type::None, Model::Type::None}
{
  ...
  Ion::Storage::FileSystem::sharedFileSystem->recordNameVerifier()->registerArrayOfReservedNames(&Store::k_functionName, Ion::Storage::regExtension, Shared::DoublePairStore::k_numberOfSeries, 1);
}
