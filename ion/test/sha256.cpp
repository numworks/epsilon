...
void computeSha256AndCompare(const uint8_t * message, uint64_t dataLength, uint8_t * expected) {
  ...
  quiz_assert(memcmp(digest, expected, 32) == 0);
}
...
QUIZ_CASE(ion_sha256) {
  // Empty Message
  {
    ...
    computeSha256AndCompare(message, 0, expected);
  }
  // 1 chunk
  {
    uint8_t message[44] = "The quick brown fox jumps over the lazy dog";
    uint8_t expected[32] = {
    ...
    computeSha256AndCompare(message, 43, expected);
  }
  // 1 chunk, maximal message size
  {
    uint8_t message[56] = "The quick brown fox jumps over the lazy dog567890123456";
    uint8_t expected[32] = {
    ...
    computeSha256AndCompare(message, 55, expected);
  }
  // 2 chunks, minimal message size
  {
    uint8_t message[57] = "The quick brown fox jumps over the lazy dog5678901234567";
    uint8_t expected[32] = {
    ...
    computeSha256AndCompare(message, 56, expected);
  }
  // 2 chunks, only dataLenght in chunk 2
  {
    uint8_t message[64] = "The quick brown fox jumps over the lazy dog56789012345678901234";
    uint8_t expected[32] = {
    ...
    computeSha256AndCompare(message, 63, expected);
  }
  // 2 chunks, only data in chunk 1
  {
    uint8_t message[65] = "The quick brown fox jumps over the lazy dog567890123456789012345";
    uint8_t expected[32] = {
    ...
    computeSha256AndCompare(message, 64, expected);
  }
  // 2 chunks
  {
    uint8_t message[87] = "The quick brown fox jumps over the lazy dogThe quick brown fox jumps over the lazy dog";
    uint8_t expected[32] = {
    ...
    computeSha256AndCompare(message, 86, expected);
  }
  // 3 chunks
  {
    uint8_t message[154] = "T     h     i     s          m     e     s     s     a     g     e          n     e     e     d     s          3          c     h     u     n     k     s";
    uint8_t expected[32] = {
    ...
    computeSha256AndCompare(message, 153, expected);
  }
}
