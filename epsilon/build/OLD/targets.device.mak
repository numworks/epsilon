...
$(BUILD_DIR)/bootloader.o: force_remake
	...
	$(Q) $(OBJCOPY) -O binary -S -R .trampoline -R .pseudo_otp -R .unused_flash $(subst $(FIRMWARE_COMPONENT),bootloader,$(BUILD_DIR))/bootloader.elf $(BUILD_DIR)/bootloader.bin
	$(Q) $(OBJCOPY) -O binary -S -j .trampoline $(subst $(FIRMWARE_COMPONENT),bootloader,$(BUILD_DIR))/bootloader.elf $(BUILD_DIR)/trampoline.bin
