...
public:
  FisherDistribution() : TwoParametersDistribution(Poincare::Distribution::Type::Fisher, k_defaultD1, k_defaultD2) { computeCurveViewRange(); }
  ...
  double defaultParameterAtIndex(int index) const override { return index == 0 ? k_defaultD1 : k_defaultD2; }
private:
