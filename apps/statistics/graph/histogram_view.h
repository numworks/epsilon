...
public:
  HistogramView(Store * store, int series, Shared::CurveViewRange * curveViewRange, KDColor selectedHistogramColor = Escher::Palette::Select, KDColor notSelectedHistogramColor = Escher::Palette::GrayMiddle, KDColor selectedBarColor = Escher::Palette::YellowDark);
