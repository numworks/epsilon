...
template Evaluation<float> SumNode::templatedEvaluateWithNewTerm<float>(Evaluation<float> a, Evaluation<float> b, ExpressionNode::ApproximationContext approximationContext) const;
template Evaluation<double> SumNode::templatedEvaluateWithNewTerm<double>(Evaluation<double> a, Evaluation<double> b, ExpressionNode::ApproximationContext approximationContext) const;
