...
public:
  ...
  // LayoutNode
  int indexAfterHorizontalCursorMove(OMG::HorizontalDirection direction, int currentIndex, bool * shouldRedrawLayout) override { /* This case is handled directly by the cursor */ assert(false); return -2; }
  ...
  bool isCollapsable(int * numberOfOpenParenthesis, OMG::HorizontalDirection direction) const override { return m_numberOfChildren != 0; }
