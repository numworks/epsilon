#ifndef GRAPH_STORAGE_CALCULATION_GRAPH_CONTROLLER_H
#define GRAPH_STORAGE_CALCULATION_GRAPH_CONTROLLER_H
...
class StorageCalculationGraphController : public ViewController, public Shared::StorageFunctionBannerDelegate<Shared::StorageCartesianFunction> {
public:
  StorageCalculationGraphController(Responder * parentResponder, StorageGraphView * graphView, BannerView * bannerView, Shared::InteractiveCurveViewRange * curveViewRange, Shared::CurveViewCursor * cursor, I18n::Message defaultMessage);
  View * view() override;
