  ...
  static constexpr const Representative
    TimeRepresentatives[] = {
        ...
        Representative("min", "60*_s",
            ...
            NoPrefix),
        Representative("h",   "60*_min",
            Representative::Prefixable::No,
            NoPrefix),
        Representative("day", "24*_h",
            Representative::Prefixable::No,
            NoPrefix),
        Representative("week", "7*_day",
            Representative::Prefixable::No,
            NoPrefix),
        Representative("month", "(365.25/12)*_day", // A month is a twelveth of a year
            Representative::Prefixable::No,
            NoPrefix),
        Representative("year", "365.25*_day",
            Representative::Prefixable::No,
            NoPrefix),
        },
