...
public:
  ...
  static HorizontalLayout Builder(Layout l1, Layout l2) { return HorizontalLayout::Builder(ArrayBuilder2<Layout>(l1, l2).array(), 2); }
  static HorizontalLayout Builder(Layout l1, Layout l2, Layout l3) { return HorizontalLayout::Builder(ArrayBuilder3<Layout>(l1, l2, l3).array(), 3); }
  static HorizontalLayout Builder(Layout l1, Layout l2, Layout l3, Layout l4) { return HorizontalLayout::Builder(ArrayBuilder4<Layout>(l1, l2, l3, l4).array(), 4); }
