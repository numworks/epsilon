...
public:
  HypergeometricDistribution() : ThreeParametersDistribution(Poincare::Distribution::Type::Hypergeometric, k_defaultN, k_defaultK, k_defaultn) { computeCurveViewRange(); }
