...
template And TreeHandle::FixedArityBuilder<And, AndNode>(const Tuple &);
template AndExplicit TreeHandle::FixedArityBuilder<AndExplicit, AndExplicitNode>(const Tuple &);
...
template BitClear TreeHandle::FixedArityBuilder<BitClear, BitClearNode>(const Tuple &);
template BitFlip TreeHandle::FixedArityBuilder<BitFlip, BitFlipNode>(const Tuple &);
template BitGet TreeHandle::FixedArityBuilder<BitGet, BitGetNode>(const Tuple &);
template BitsClear TreeHandle::FixedArityBuilder<BitsClear, BitsClearNode>(const Tuple &);
template BitsClearExplicit TreeHandle::FixedArityBuilder<BitsClearExplicit, BitsClearExplicitNode>(const Tuple &);
template BitSet TreeHandle::FixedArityBuilder<BitSet, BitSetNode>(const Tuple &);
...
template Nand TreeHandle::FixedArityBuilder<Nand, NandNode>(const Tuple &);
template NandExplicit TreeHandle::FixedArityBuilder<NandExplicit, NandExplicitNode>(const Tuple &);
template NaperianLogarithm TreeHandle::FixedArityBuilder<NaperianLogarithm, NaperianLogarithmNode>(const Tuple &);
template Nor TreeHandle::FixedArityBuilder<Nor, NorNode>(const Tuple &);
template NorExplicit TreeHandle::FixedArityBuilder<NorExplicit, NorExplicitNode>(const Tuple &);
...
template Not TreeHandle::FixedArityBuilder<Not, NotNode>(const Tuple &);
template NotExplicit TreeHandle::FixedArityBuilder<NotExplicit, NotExplicitNode>(const Tuple &);
...
template Or TreeHandle::FixedArityBuilder<Or, OrNode>(const Tuple &);
template OrExplicit TreeHandle::FixedArityBuilder<OrExplicit, OrExplicitNode>(const Tuple &);
...
template RotateLeft TreeHandle::FixedArityBuilder<RotateLeft, RotateLeftNode>(const Tuple &);
template RotateLeftExplicit TreeHandle::FixedArityBuilder<RotateLeftExplicit, RotateLeftExplicitNode>(const Tuple &);
template RotateRight TreeHandle::FixedArityBuilder<RotateRight, RotateRightNode>(const Tuple &);
template RotateRightExplicit TreeHandle::FixedArityBuilder<RotateRightExplicit, RotateRightExplicitNode>(const Tuple &);
template Round TreeHandle::FixedArityBuilder<Round, RoundNode>(const Tuple &);
template ShiftArithmeticRight TreeHandle::FixedArityBuilder<ShiftArithmeticRight, ShiftArithmeticRightNode>(const Tuple &);
template ShiftArithmeticRightExplicit TreeHandle::FixedArityBuilder<ShiftArithmeticRightExplicit, ShiftArithmeticRightExplicitNode>(const Tuple &);
template ShiftLogicLeft TreeHandle::FixedArityBuilder<ShiftLogicLeft, ShiftLogicLeftNode>(const Tuple &);
template ShiftLogicLeftExplicit TreeHandle::FixedArityBuilder<ShiftLogicLeftExplicit, ShiftLogicLeftExplicitNode>(const Tuple &);
template ShiftLogicRight TreeHandle::FixedArityBuilder<ShiftLogicRight, ShiftLogicRightNode>(const Tuple &);
template ShiftLogicRightExplicit TreeHandle::FixedArityBuilder<ShiftLogicRightExplicit, ShiftLogicRightExplicitNode>(const Tuple &);
...
template XorExplicit TreeHandle::FixedArityBuilder<XorExplicit, XorExplicitNode>(const Tuple &);
}
