...
QUIZ_CASE(poincare_polynomial_roots_cubic) {
  ...
  assert_roots_of_polynomial_are("2x^3-ℯ^(2𝐢π/7)", {"7.937005ᴇ-1×ℯ^-1.795196×𝐢", "7.937005ᴇ-1×ℯ^2.991993ᴇ-1×𝐢", "7.937005ᴇ-1×ℯ^2.393594×𝐢"}, "1.08ᴇ2×ℯ^-1.346397×𝐢", Polar);
  ...
  assert_roots_of_polynomial_are("(x-2𝐢+1)(x+3𝐢-1)(x-𝐢+2)", {"1-3×𝐢", "-2+1×𝐢", "-1+2×𝐢"}, "-1288-666×𝐢", Cartesian);
