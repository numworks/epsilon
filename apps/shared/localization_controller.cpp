  ...
  m_borderView(Palette::GrayBright)
{
  ...
  m_countryTitleMessage.setAlignment(KDFont::ALIGN_CENTER, KDFont::ALIGN_CENTER);
  ...
  for (int i = 0; i < k_numberOfCountryWarningLines; i++) {
    ...
    m_countryWarningLines[i].setAlignment(KDFont::ALIGN_CENTER, KDFont::ALIGN_CENTER);
