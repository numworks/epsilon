...
QUIZ_CASE(poincare_substraction_evaluate) {
  ...
  assert_parsed_expression_evaluate_to("[[1,2+I][3,4][5,6]]-(4+I)", d, 3, 2);
  ...
  assert_parsed_expression_evaluate_to("3-[[1,2][3,4][5,6]]", e, 3, 2);
  ...
  assert_parsed_expression_evaluate_to("3+I-[[1,2+I][3,4][5,6]]", f, 3, 2);
  ...
  assert_parsed_expression_evaluate_to("[[1,2][3,4][5,6]]-[[6,5][4,3][2,1]]", g, 3, 2);
  ...
  assert_parsed_expression_evaluate_to("[[1,2+I][3,4][5,6]]-[[1,2+I][3,4][5,6]]", h, 3, 2);
#endif
}
