...
private:
  ...
  private:
    constexpr static int k_maxTitleLength = (Ion::Display::Width - Metric::PopUpLeftMargin - 2 * Metric::CellSeparatorThickness - Metric::CellLeftMargin - Metric::CellRightMargin - Metric::PopUpRightMargin) / KDFont::GlyphWidth(KDFont::Size::Small);
    constexpr static int k_maxModelTreeDepth = StackViewController::k_maxNumberOfChildren-1;
    void updateTitle();
    SelectableTableView * m_selectableTableView;
    int m_titleCount;
