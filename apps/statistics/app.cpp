...
App::App(Snapshot * snapshot, Poincare::Context * parentContext) :
  ...
  m_normalProbabilityController(&m_normalProbabilityHeader, &m_normalProbabilityHeader, &m_tabViewController, &m_graphMenuStackViewController, &m_graphTypeController, snapshot->store(), snapshot->selectedBoxSeriesIndex(), snapshot->selectedHistogramBarIndex()),
  m_normalProbabilityHeader(&m_graphController, &m_normalProbabilityController, &m_normalProbabilityController),
  m_frequencyController(&m_frequencyHeader, &m_frequencyHeader, &m_tabViewController, &m_graphMenuStackViewController, &m_graphTypeController, snapshot->store(), snapshot->selectedBoxSeriesIndex(), snapshot->selectedHistogramBarIndex()),
