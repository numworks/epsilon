#ifndef PROBABILITY_ABSTRACT_CHAINED_SELECTABLE_TABLE_DELEGATE_H
#define PROBABILITY_ABSTRACT_CHAINED_SELECTABLE_TABLE_DELEGATE_H
...
#endif /* PROBABILITY_ABSTRACT_CHAINED_SELECTABLE_TABLE_DELEGATE_H */
