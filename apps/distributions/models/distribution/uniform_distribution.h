...
public:
  UniformDistribution() : TwoParametersDistribution(Poincare::Distribution::Type::Uniform, k_defaultA, k_defaultB) { computeCurveViewRange(); }
  ...
  double defaultParameterAtIndex(int index) const override { return index == 0 ? k_defaultA : k_defaultB; }
