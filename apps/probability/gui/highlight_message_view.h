#ifndef APPS_PROBABILITY_GUI_HIGHLIGHT_MESSAGE_VIEW_H
#define APPS_PROBABILITY_GUI_HIGHLIGHT_MESSAGE_VIEW_H
...
#endif /* APPS_PROBABILITY_GUI_HIGHLIGHT_MESSAGE_VIEW_H */
