...
constexpr size_t HashVariables = 8;
...
void processChunk(uint8_t * chunk, uint32_t * h) {
  ...
  constexpr size_t messageScheduleArrayWords = 64;
  ...
  */
  ...
  for (size_t i = 16; i < messageScheduleArrayWords; ++i) {
  ...
  for (size_t i = 0; i < messageScheduleArrayWords; ++i) {
