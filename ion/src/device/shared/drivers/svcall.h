...
#define SVC_BOARD_DOWNGRADE_TRUST_LEVEL 8
#define SVC_BOARD_SWITCH_EXECUTABLE_SLOT 9
#define SVC_CIRCUIT_BREAKER_HAS_CHECKPOINT 10
#define SVC_CIRCUIT_BREAKER_LOAD_CHECKPOINT 11
#define SVC_CIRCUIT_BREAKER_SET_CHECKPOINT 12
...
#define SVC_DISPLAY_COLORED_TILING_SIZE_10 17
#define SVC_DISPLAY_POST_PUSH_MULTICOLOR 18
#define SVC_DISPLAY_PULL_RECT 19
#define SVC_DISPLAY_PUSH_RECT 20
#define SVC_DISPLAY_PUSH_RECT_UNIFORM 21
#define SVC_DISPLAY_UNIFORM_TILING_SIZE_10 22
#define SVC_DISPLAY_WAIT_FOR_V_BLANK 23
#define SVC_EVENTS_COPY_TEXT 24
#define SVC_EVENTS_GET_EVENT 25
#define SVC_EVENTS_IS_DEFINED 26
#define SVC_EVENTS_REPETITION_FACTOR 27
#define SVC_EVENTS_SET_SHIFT_ALPHA_STATUS 28
#define SVC_EVENTS_SHIFT_ALPHA_STATUS 29
#define SVC_FCC_ID 30
#define SVC_FLASH_ERASE_SECTOR 31
#define SVC_FLASH_MASS_ERASE 32
#define SVC_FLASH_WRITE_MEMORY 33
...
#define SVC_PERSISTING_BYTES_READ 39
#define SVC_PERSISTING_BYTES_WRITE 40
#define SVC_POWER_SELECT_STANDBY_MODE 41
#define SVC_POWER_STANDBY 42
#define SVC_POWER_SUSPEND 43
#define SVC_RANDOM 44
#define SVC_RESET_CORE 45
#define SVC_SERIAL_NUMBER_COPY 46
#define SVC_TIMING_MILLIS 47
#define SVC_TIMING_MSLEEP 48
#define SVC_TIMING_USLEEP 49
#define SVC_USB_DID_EXECUTE_DFU 50
#define SVC_USB_IS_PLUGGED 51
#define SVC_USB_SHOULD_INTERRUPT 52
#define SVC_USB_WILL_EXECUTE_DFU 53

#define SVC_NUMBER_OF_CALLS 54
