...
template<typename T>
const Expression SequenceCacheContext<T>::protectedExpressionForSymbolAbstract(const Poincare::SymbolAbstract & symbol, bool clone, ContextWithParent * lastDescendantContext) {
  // [u|v|w](n(+1)?)
