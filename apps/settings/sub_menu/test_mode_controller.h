...
public:
  TestModeController(Escher::Responder * parentResponder, MainController * mainController) : GenericSubController(parentResponder), m_mainController(mainController) {}
