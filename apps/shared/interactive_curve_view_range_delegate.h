...
public:
  ...
  static void DefaultComputeXRange(float * xMin, float * xMax, float * yMinIntrinsic, float * yMaxIntrinsic, Poincare::Context * context, FunctionStore * functionStore);
  ...
  virtual void computeXRange(float * xMin, float * xMax, float * yMinIntrinsic, float * yMaxIntrinsic) { assert(false); }
