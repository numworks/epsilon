...
CalculationTypeController::CalculationTypeController(Responder * parentResponder, Distribution * distribution,
...
View * CalculationTypeController::view() { return &m_selectableTableView; }

void CalculationTypeController::viewWillAppear() { selectCellAtLocation(0, (int)m_calculation->type()); }

void CalculationTypeController::viewDidDisappear() { m_selectableTableView.deselectTable(); }
...
KDCoordinate CalculationTypeController::cellWidth() { return ImageCell::k_width; }
