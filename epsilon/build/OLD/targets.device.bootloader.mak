...
$(BUILD_DIR)/bootloader.$(EXE): LDFLAGS += -Lion/src/$(PLATFORM)/core/device/bootloader/flash/$(MODEL)
$(BUILD_DIR)/bootloader.$(EXE): LDSCRIPT = ion/src/$(PLATFORM)/core/device/bootloader/flash/bootloader_flash.ld
