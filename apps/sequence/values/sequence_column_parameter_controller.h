...
class SequenceColumnParameterController : public Shared::ColumnParameterController {
public:
  SequenceColumnParameterController(ValuesController * valuesController);

  bool handleEvent(Ion::Events::Event event) override;
  int numberOfRows() const override { return k_totalNumberOfCell; }
  Escher::HighlightCell * reusableCell(int index, int type) override { assert(index == 0); return &m_showSumCell; }
