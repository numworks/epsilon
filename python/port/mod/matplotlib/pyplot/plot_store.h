...
public:
  ...
  public:
    ...
    KDColor ec() const { return m_ec; }
    KDColor fc() const {return m_fc; }
  private:
    float m_xStart;
    float m_yStart;
    float m_xEnd;
  ...
  void addSegment(mp_obj_t xStart, mp_obj_t yStart, mp_obj_t xEnd, mp_obj_t yEnd, KDColor ec, KDColor fc, mp_obj_t arrowWidth = mp_obj_new_float(NAN));
