...
public:
  ...
  static PredictionInterval Builder(Expression child0, Expression child1) { return TreeHandle::FixedArityBuilder<PredictionInterval, PredictionIntervalNode>(ArrayBuilder2<TreeHandle>(child0, child1).array(), 2); }
