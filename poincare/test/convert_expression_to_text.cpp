...
QUIZ_CASE(poincare_decimal_to_text) {
  ...
  assert_expression_prints_to(&e17, "9999999999999.6");
  Decimal e18(99999999999999.6);
  assert_expression_prints_to(&e18, "1E14");
  Decimal e19(999999999999999.6);
  assert_expression_prints_to(&e19, "1E15");
  Decimal e20(9999999999999999.6);
  assert_expression_prints_to(&e20, "1E16");
}
