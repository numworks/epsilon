...
public:
  ...
  constexpr static KDCoordinate GlyphWidth(Size size) { return size == Size::Small ? k_glyphWidthSmallFont : k_glyphWidthLargeFont; }
  constexpr static KDCoordinate GlyphHeight(Size size) { return size == Size::Small ? k_glyphHeightSmallFont : k_glyphHeightLargeFont; }
  constexpr static KDSize GlyphSize(Size size) { return KDSize(GlyphWidth(size), GlyphHeight(size)); }
  // TODO: Should be generated by the rasterizer
  constexpr static KDCoordinate k_glyphWidthSmallFont = 7;
  constexpr static KDCoordinate k_glyphHeightSmallFont = 14;
  constexpr static KDCoordinate k_glyphWidthLargeFont = 10;
  constexpr static KDCoordinate k_glyphHeightLargeFont = 18;
  constexpr static int k_maxGlyphPixelCount = k_glyphWidthLargeFont * k_glyphHeightLargeFont;
