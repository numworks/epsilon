...
// TODO create model for DataSource
...
private:
  struct IntRepr { char m_content[10]; };
...
class InputGoodnessController : public ViewController, InputGoodnessDataSource {
 public:
  InputGoodnessController(Responder * parent, InputEventHandlerDelegate * inputEventHandlerDelegate, TextFieldDelegate * textFieldDelegate);
