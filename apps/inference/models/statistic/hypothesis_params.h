...
public:
  HypothesisParams() : m_firstParam(0.0), m_operator(Poincare::ComparisonNode::OperatorType::Superior) {}

  double firstParam() const { return m_firstParam; }
  void setFirstParam(double firstParam) { m_firstParam = firstParam; }

  Poincare::ComparisonNode::OperatorType comparisonOperator() const { return m_operator; }
  void setComparisonOperator(const Poincare::ComparisonNode::OperatorType op) {
    assert(op == Poincare::ComparisonNode::OperatorType::Inferior || op == Poincare::ComparisonNode::OperatorType::Superior || op == Poincare::ComparisonNode::OperatorType::NotEqual);
    m_operator = op;
  }
