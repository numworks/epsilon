#ifndef PROBABILITY_MODELS_STATISTIC_TWO_PROPORTIONS_Z_INTERVAL_H
#define PROBABILITY_MODELS_STATISTIC_TWO_PROPORTIONS_Z_INTERVAL_H
...
#endif /* PROBABILITY_MODELS_STATISTIC_TWO_PROPORTIONS_Z_INTERVAL_H */
