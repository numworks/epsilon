...
$$(BUILD_DIR)/htmlpack$(1)zip: $$(addprefix $$(BUILD_DIR)/ion/src/simulator/web/,calculator.html calculator.css) $$(BUILD_DIR)/epsilon$(1)js ion/src/simulator/web/calculator.js ion/src/simulator/assets/background_with_shadow.webp $(BUILD_DIR)ion/src/simulator/assets/background.jpg $(BUILD_DIR)ion/src/simulator/assets/background_no_shadow.webp
endef
