...
QUIZ_CASE(poincare_parsing_identifiers) {
  ...
  assert_parsed_expression_is("and(1,1,1)", AndExplicit::Builder(BasedInteger::Builder(1), BasedInteger::Builder(1), BasedInteger::Builder(1)));
  assert_parsed_expression_is("nand(1,1)", Nand::Builder(BasedInteger::Builder(1), BasedInteger::Builder(1)));
  assert_parsed_expression_is("nand(1,1,1)", NandExplicit::Builder(BasedInteger::Builder(1), BasedInteger::Builder(1), BasedInteger::Builder(1)));
  assert_parsed_expression_is("or(1,1)", Or::Builder(BasedInteger::Builder(1), BasedInteger::Builder(1)));
  assert_parsed_expression_is("or(1,1,1)", OrExplicit::Builder(BasedInteger::Builder(1), BasedInteger::Builder(1), BasedInteger::Builder(1)));
  assert_parsed_expression_is("nor(1,1)", Nor::Builder(BasedInteger::Builder(1), BasedInteger::Builder(1)));
  assert_parsed_expression_is("nor(1,1,1)", NorExplicit::Builder(BasedInteger::Builder(1), BasedInteger::Builder(1), BasedInteger::Builder(1)));
  ...
  assert_parsed_expression_is("xnor(1,1)", Xnor::Builder(BasedInteger::Builder(1), BasedInteger::Builder(1)));
