#ifndef INFERENCE_PROBABILITY_CALCULATION_POPUP_DATA_SOURCE_H
#define INFERENCE_PROBABILITY_CALCULATION_POPUP_DATA_SOURCE_H
...
#endif /* INFERENCE_PROBABILITY_CALCULATION_POPUP_DATA_SOURCE_H */
