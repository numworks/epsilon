...
class Image {
public:
  constexpr Image(KDCoordinate width, KDCoordinate height, const uint8_t * compressedPixelData, uint16_t compressedPixelDataSize, bool hasTransparency = false) :
    m_width(width), m_height(height), m_compressedPixelData(compressedPixelData), m_compressedPixelDataSize(compressedPixelDataSize), m_hasTransparency(hasTransparency) {}
