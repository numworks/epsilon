...
template Evaluation<float> ProductNode::templatedEvaluateWithNewTerm<float>(Evaluation<float> a, Evaluation<float> b, ExpressionNode::ApproximationContext approximationContext) const;
template Evaluation<double> ProductNode::templatedEvaluateWithNewTerm<double>(Evaluation<double> a, Evaluation<double> b, ExpressionNode::ApproximationContext approximationContext) const;
