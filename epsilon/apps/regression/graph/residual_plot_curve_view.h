...
class ResidualPlotCurveView
    : public Shared::PlotView<
          Shared::PlotPolicy::TwoLabeledAxes, ResidualPlotPolicy,
          Shared::PlotPolicy::WithBanner, Shared::PlotPolicy::WithCursor> {
 public:
  ResidualPlotCurveView(Shared::CurveViewRange* range,
                        Shared::CurveViewCursor* cursor,
                        Shared::BannerView* banner,
