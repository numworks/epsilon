...
int Print::UInt32(Base base, uint32_t integer, LeadingZeros printLeadingZeros, char * buffer, int bufferSize) {
  ...
  size_t length = printLeadingZeros == LeadingZeros::Keep ? MaxLengthOfUInt32(base) : LengthOfUInt32(base, integer);
