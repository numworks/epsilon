...
template <typename T>
Expression BooleanEvaluationNode<T>::complexToExpression(Preferences::Preferences::ComplexFormat complexFormat) const {
...
template BooleanEvaluation<double> BooleanEvaluation<double>::Builder(bool value);

Layout BooleanNode::createLayout(Preferences::PrintFloatMode floatDisplayMode, int numberOfSignificantDigits, Context * context) const {
