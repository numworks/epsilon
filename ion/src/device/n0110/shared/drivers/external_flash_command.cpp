...
void send_command(Command c, QUADSPI::CCR::OperatingMode operatingMode) {
  send_command_full(
...
void send_write_command(Command c, uint8_t * address, const uint8_t * data, size_t dataLength, QUADSPI::CCR::OperatingMode operatingMode) {
  send_command_full(
    QUADSPI::CCR::FunctionalMode::IndirectWrite,
    operatingMode,
    c,
...
void send_read_command(Command c, uint8_t * address, uint8_t * data, size_t dataLength, QUADSPI::CCR::OperatingMode operatingMode) {
  send_command_full(
...
void wait(QUADSPI::CCR::OperatingMode operatingMode) {
