...
public:
  GraphController(Escher::Responder * parentResponder, Escher::InputEventHandlerDelegate * inputEventHandlerDelegate, Escher::ButtonRowController * header, CurveViewRange * interactiveRange, Shared::CurveViewCursor * cursor, int * selectedCurveIndex, Shared::SequenceStore * sequenceStore);
