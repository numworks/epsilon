...
public:
  ExponentialDistribution() : OneParameterDistribution(Poincare::Distribution::Type::Exponential, k_defaultLambda) { computeCurveViewRange(); }
  ...
  double defaultParameterAtIndex(int index) const override { return k_defaultLambda; }
