...
private:
  ...
  constexpr static Model::Type DefaultModelTypeAtIndex(int index) { return static_cast<Model::Type>(index + 1); }
  constexpr static int DefaultIndexOfModelType(Model::Type type) { return static_cast<int>(type) - 1; }
  ...
  constexpr static Model::Type VariantModelTypeAtIndex(int index) { return VariantModel[index]; }
