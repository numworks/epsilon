...
void SVC_ATTRIBUTES eadk_display_push_rect(eadk_rect_t rect,
                                           const eadk_color_t* pixels) {
  SVC_RETURNING_VOID(SVC_DISPLAY_PUSH_RECT)
}

void SVC_ATTRIBUTES eadk_display_push_rect_uniform(eadk_rect_t rect,
                                                   eadk_color_t color) {
  SVC_RETURNING_VOID(SVC_DISPLAY_PUSH_RECT_UNIFORM)
}

void SVC_ATTRIBUTES eadk_display_pull_rect(eadk_rect_t rect,
                                           eadk_color_t* pixels) {
