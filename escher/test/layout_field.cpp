...
void assert_events_lead_to_selection(
    const Ion::Events::Event* events, int numberOfEvents,
    const char* selectedParsedAndSerializedText) {
...
QUIZ_CASE(escher_layout_field_select_left_right) {
  ...
  }
  {
    ...
    Ion::Events::Event events[eventsCount] = {
        ...
        Ion::Events::Three,      Ion::Events::Left,
        Ion::Events::Left,       Ion::Events::Left,
...
QUIZ_CASE(escher_layout_field_delete) {
  ...
  }
  {
    ...
    Ion::Events::Event events[eventsCount] = {
        Ion::Events::One,        Ion::Events::Two,
        Ion::Events::Three,      Ion::Events::Four,
        Ion::Events::Left,       Ion::Events::ShiftLeft,
        Ion::Events::ShiftLeft,  Ion::Events::Zero,
        Ion::Events::Left,       Ion::Events::Left,
        Ion::Events::ShiftRight, Ion::Events::ShiftRight,
        Ion::Events::ShiftRight};
