...
QUIZ_CASE(poincare_fraction_evaluate) {
  ...
  assert_parsed_expression_evaluate_to("[[1,2][3,4][5,6]]/2", c, 3, 2);
  ...
  assert_parsed_expression_evaluate_to("[[1,2][3,4]]/[[3,4][5,6]]", e, 2, 2);
  ...
  assert_parsed_expression_evaluate_to("3/[[3,4][5,6]]", f, 2, 2);
  ...
  assert_parsed_expression_evaluate_to("(3+4i)/[[1,2+i][3,4][5,6]]", g, 2, 2);*/
