...
SimpleInterestMenuController::SimpleInterestMenuController(Escher::StackViewController * parentResponder, SimpleInterestController * simpleInterestController, FinanceData * data) :
      Shared::SelectableCellListPage<Escher::MessageTableCellWithChevronAndMessage, k_numberOfSimpleInterestCells>(parentResponder, &m_contentView), m_contentView(&m_selectableTableView, this, I18n::Message::ParameterChoose), m_simpleInterestController(simpleInterestController), m_data(data) {
  selectRow(0);
