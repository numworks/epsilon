...
void approximates_to(
    ...
    const Poincare::Internal::ProjectionContext& projectionContext = realCtx);
template <typename T>
void approximates_to(
...
void approximates_to_float_and_double(
    ...
    Poincare::Internal::ProjectionContext projCtx = realCtx);
...
void approximates_to_boolean(
    const char* input,
    Poincare::Internal::Approximation::BooleanOrUndefined expected,
    const Poincare::Internal::ProjectionContext& projectionContext);
