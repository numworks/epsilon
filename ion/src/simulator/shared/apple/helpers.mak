...
ifeq ($(SIMULATOR_ICON_USE_MASK),1)
	$(Q) convert -background "#FFB734" MSVG:$< -gravity center -scale 80% -extent 1024x1024 MSVG:ion/src/simulator/assets/icon_mask.svg -alpha Off -compose CopyOpacity -composite -resize $* $@
else
	$(Q) convert -background "#FFB734" -resize $* MSVG:$< $@
endif
