...
#define SVC_BACKLIGHT_INIT 18
#define SVC_BACKLIGHT_SHUTDOWN 19
#define SVC_BACKLIGHT_IS_INITIALIZED 20
#define SVC_BACKLIGHT_SET_BRIGHTNESS 21
#define SVC_BACKLIGHT_BRIGHTNESS 22
