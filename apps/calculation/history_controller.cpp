    ...
    if (subviewType == SubviewType::Input) {
      ...
      if (CircuitBreakerRun(checkpoint)) {
        ...
        if (additionalInfoType == Calculation::AdditionalInformationType::Complex) {
          ...
          // Find which of the input or output is the cosine/sine/tangent/cotangent
          ExpressionNode::Type t = e.type();
          e = t == ExpressionNode::Type::Cosine || t == ExpressionNode::Type::Sine || t == ExpressionNode::Type::Tangent ? e : calculationAtIndex(focusRow)->input();
