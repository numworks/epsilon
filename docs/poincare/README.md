...
![A example expression tree of Epsilon software](expression-tree.svg)
...
![Addition associative rule on a expression tree](rtti.svg)

## Expression parsing

Lexing and parsing are done by homemade lexer and parser available [here](/poincare/src/parsing).

## Simplification

![Simplify an expression tree](simplify.svg)
...
![Order relationship on expressions](order.svg)
...
![Reduce expression tree](reduce.svg)
...
![Beautify expression tree](beautify.svg)
...
![Expression layout tree](layout.svg)

![Expression layout baseline](baseline.svg)
