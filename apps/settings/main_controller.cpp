...
constexpr MessageTree s_modelExamChildren[4] = {MessageTree(I18n::Message::ActivateExamMode), MessageTree(I18n::Message::ActivateDutchExamMode), MessageTree(I18n::Message::ActivatePortugueseExamMode), MessageTree(I18n::Message::ActivateIBExamMode)};
