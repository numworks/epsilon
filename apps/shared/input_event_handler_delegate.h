...
public:
  Escher::PervasiveBox * toolbox() override { return inputEventHandlerDelegateApp()->toolbox(); }
  Escher::PervasiveBox * variableBox() override { return inputEventHandlerDelegateApp()->variableBox(); }
private:
