...
USERLAND_LDDEPS += ion/src/$(PLATFORM)/userland/flash/shared_userland_flash.ld ion/src/$(PLATFORM)/userland/flash/$(MODEL)/signature.ld ion/src/$(PLATFORM)/userland/flash/$(MODEL)/external_apps.ld
