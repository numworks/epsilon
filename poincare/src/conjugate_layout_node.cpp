...
int ConjugateLayoutNode::writeTextInBuffer(char * buffer, int bufferSize, int numberOfSignificantDigits) const {
  return LayoutEngine::writePrefixSerializableRefTextInBuffer(SerializableRef(const_cast<ConjugateLayoutNode *>(this)), buffer, bufferSize, numberOfSignificantDigits, "conj");
}
