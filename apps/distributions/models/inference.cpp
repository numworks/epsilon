...
Distributions::Inference() : Shared::MemoizedCurveViewRange() {
}

bool Distributions::Initialize(Inference * inference, SubApp subApp) {
...
void Distributions::computeCurveViewRange() {
...
bool Distributions::authorizedParameterAtIndex(double x, int index) const {
