...
$(filter %.A.$(EXE),$(userland_targets)): LDSCRIPT = ion/src/$(PLATFORM)/$(MODEL)/userland/userland_A_flash.ld
$(filter %.B.$(EXE),$(userland_targets)): LDSCRIPT = ion/src/$(PLATFORM)/$(MODEL)/userland/userland_B_flash.ld
