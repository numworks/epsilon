...
void CalculationController::willDisplayCellAtLocation(HighlightCell * cell, int i, int j) {
  ...
  case k_calculationSymbolCellType: {
    ...
    I18n::Message titles[k_fixedNumberOfRows - 2][k_numberOfHeaderColumns] = {
      ...
      { I18n::Message::Mean, GlobalPreferences::sharedGlobalPreferences()->meanSymbol() == CountryPreferences::MeanSymbol::WithMu ? I18n::Message::MeanDoubleSymbol : I18n::Message::MeanSymbol },
