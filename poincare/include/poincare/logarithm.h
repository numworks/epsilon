...
public:
  ...
  static Logarithm Builder(Expression child0, Expression child1) { return TreeHandle::FixedArityBuilder<Logarithm, LogarithmNode<2>>(ArrayBuilder2<TreeHandle>(child0, child1).array(), 2); }
