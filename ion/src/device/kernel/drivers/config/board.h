...
constexpr static uint32_t KernelExternalLength = 64*1024 - ExamMode::Config::ExamModeBufferSize - SizeSize - SignatureSize; // TODO Emilie: Compute from config_flash.ld??
