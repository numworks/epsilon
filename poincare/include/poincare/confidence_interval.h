...
public:
  ...
  static ConfidenceInterval Builder(Expression child0, Expression child1) { return TreeHandle::FixedArityBuilder<ConfidenceInterval, ConfidenceIntervalNode>(ArrayBuilder2<TreeHandle>(child0, child1).array(), 2); }
...
public:
  ...
  static SimplePredictionInterval Builder(Expression child0, Expression child1) { return TreeHandle::FixedArityBuilder<SimplePredictionInterval, SimplePredictionIntervalNode>(ArrayBuilder2<TreeHandle>(child0, child1).array(), 2); }
