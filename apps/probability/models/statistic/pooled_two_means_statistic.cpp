...
float PooledTwoMeansStatistic::computeDegreesOfFreedom(float s1, int n1, float s2, int n2) {
  return n1 + n2 - 2;
}

float PooledTwoMeansStatistic::computeStandardError(float s1, int n1, float s2, int n2) {
